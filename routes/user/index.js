...
// Prepare Core Router
let userRouter = Router()// User Subscribe

userRouter.post('/stripe/subscribe', async  (req, res) => {
...
userRouter.post('/stripe/customer-portal', async  (req, res) => {
	try {
...
userRouter.post('/stripe/activate', async  (req, res) => {
	try {
		// This is the url to which the customer will be redirected when they are done
			// managing their billing with the portal.
			const domainURL = process.env.DOMAIN;
...
userRouter.post('/stripe/cancel', async  (req, res) => {
	try {
		// This is the url to which the customer will be redirected when they are done
			// managing their billing with the portal.
			const domainURL = process.env.DOMAIN;
...
userRouter.post('/stripe/uncancel', async  (req, res) => {
	try {
		// This is the url to which the customer will be redirected when they are done
			// managing their billing with the portal.
			const domainURL = process.env.DOMAIN;
...
userRouter.post('/stripe/plan', async  (req, res) => {
	try {
		let user = await User.findOne({ _id: req.user._id })
...
userRouter.post('/refresh/profile', async  (req, res) => {
	let user = await User.findOne({ _id: req.user._id })
	let profile = {
        ...user.toObject()
    }
...
userRouter.post('/feedback/view', async  (req, res) => {
	try {
